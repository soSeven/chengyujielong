...
class LotteryCoinView: UIView {
    ...
    init(coin: Int) {
        ...
        let titleImg = UIImage.create("cash_reward_img_tl")
        ...
        lbl1.height = 14.uiX
        lbl1.width = width
        lbl1.attributedText = getAttributedText(n: UserManager.shared.user?.goldCoin ?? 0)
        ...
        btn.rx.tap.subscribe(onNext: {[weak self] _ in
            ...
            MobClick.event("withdrawal_Continue")
            self.action?()
